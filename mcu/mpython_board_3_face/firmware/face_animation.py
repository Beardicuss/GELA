...
class GelaWifi:
    ...
    def push_to_talk(self):
        ...
        self.animator.set_state(STATE_LISTEN); self.animator.set_status("SPEAK - 4 SEC")
        try:
...
def run():
    ...
    while True:
        ...
        elif a and not b and not handled and time.ticks_diff(now,a_started)>=180:handled=True; wifi.push_to_talk()
